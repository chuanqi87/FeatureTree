...
开发者可以通过在module.json5配置文件中[abilities标签](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#abilities标签)下的supportWindowMode属性增加"floating"字段或使用缺省值以声明应用支持悬浮窗。  
![](https://media:201787906081401211)  
...
开发者可以通过在module.json5配置文件中[abilities标签](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#abilities标签)下的supportWindowMode属性增加"split"字段或使用缺省值以声明应用支持分屏。  
![](https://media:201787906081434212)  
supportWindowMode缺省值为\["fullscreen", "split", "floating"\]。
...
![](https://media:201787906081465213)

图2 启动右侧分屏

![](https://media:201787906081489214)

图3 以左分屏占较大比例启动

![](https://media:201787906081518215)

图4 以右分屏占较大比例启动

![](https://media:201787906081555216)

图5 从二分屏拉起应用内分屏，形成三分屏

![](https://media:201787906081584217)  
