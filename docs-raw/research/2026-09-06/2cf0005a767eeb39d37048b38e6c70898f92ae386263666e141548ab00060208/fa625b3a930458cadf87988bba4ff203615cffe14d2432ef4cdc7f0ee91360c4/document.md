...
5. Click **Screen Record** ![](/static/images/tools/am-ivideo.png) in the left side of
   the Logcat window.
...
10. In the **Screen Recorder** dialog, click one of the buttons to show the file location,
...
![](/static/studio/images/debug/video-emulator_2x.png)
