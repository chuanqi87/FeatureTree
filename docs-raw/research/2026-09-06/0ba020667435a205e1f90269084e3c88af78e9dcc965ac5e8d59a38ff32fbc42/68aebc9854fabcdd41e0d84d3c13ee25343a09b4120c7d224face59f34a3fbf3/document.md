...
[asynchronous work](https://developer.android.com/guide/background#asynchronous-work), the
[task scheduling APIs](https://developer.android.com/guide/background#background-work),
and [foreground services](https://developer.android.com/guide/background#foreground-services).

## Choose the right option

In most scenarios, you can figure out the right APIs to use for your task by
figuring out the category ([asynchronous work](https://developer.android.com/guide/background#asynchronous-work), the
[task scheduling APIs](https://developer.android.com/guide/background#background-work), or
[foreground services](https://developer.android.com/guide/background#foreground-services)) the
task falls under.
...
* [The task initiated by the user while the app is visible](https://developer.android.com/guide/background#user-initiated)
* [The task is initiated in response to an event, either internal or
  external](https://developer.android.com/guide/background#event-driven)
...
background, you should use [asynchronous work](https://developer.android.com/guide/background#asynchronous-work). There are a
...
the [background work](https://developer.android.com/guide/background#background-work) options.
...
[foreground service](https://developer.android.com/guide/background#foreground-services) may be the best option.


### Is it a short, critical task?

If the task cannot be delayed and it will complete quickly, you can use a
[foreground service](https://developer.android.com/guide/background#foreground-services) with the type
...
[foreground service](https://developer.android.com/guide/background#foreground-services). These services run continuously once
...
[alternative API](https://developer.android.com/guide/background#alternative-apis) that handles the job for you with less
...
work](https://developer.android.com/guide/background#asynchronous-work) to perform the task. The system will allow your app a
