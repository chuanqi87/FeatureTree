...
[Enable WebDriver on macOS](/documentation/Safari-Developer-Tools/macos-enabling-webdriver)

Enable WebDriver to automate testing of Safari on macOS.

[Enable WebDriver on iOS and iPadOS](/documentation/Safari-Developer-Tools/ios-enabling-webdriver)
