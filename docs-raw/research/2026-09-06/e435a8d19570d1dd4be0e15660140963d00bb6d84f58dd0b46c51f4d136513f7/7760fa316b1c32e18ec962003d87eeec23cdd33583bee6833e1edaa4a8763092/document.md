# About continuity and cross-device play
...
* [Google Play Games | Level Up guidelines](https://developer.android.com/games/guidelines#cloud-save) for cloud save and
  player continuity requirements
* [Developer documentation](https://developer.android.com/games/pgs/overview) for integrating
  Play Games Services v2 within your game
* [Seamless restore documentation](https://developer.android.com/games/pgs/seamless-restore) for automatic sign-in
  and account linking
