...
[Navigation component](https://developer.android.com/topic/libraries/architecture/navigation) is designed to
...
[conditional screens](https://developer.android.com/topic/libraries/architecture/navigation/navigation-conditional)
...
[new task](https://developer.android.com/guide/components/activities/tasks-and-back-stack)
...
The [Navigation component](https://developer.android.com/topic/libraries/architecture/navigation) manages
...
The Up button appears in the [app bar](https://developer.android.com/training/appbar) at the top of the
...
When your app is launched using a [deep link](https://developer.android.com/training/app-links/deep-linking)
on another app's task, Up transitions users back to your app’s task and through
a [simulated back stack](https://developer.android.com/guide/navigation/principles#deep-link) and not to the app that triggered the deep
link. The Back button, however, does take you back to the other app.

## Deep linking simulates manual navigation

Whether [deep linking](https://developer.android.com/training/app-links/deep-linking) or manually navigating
...
complex, [nested navigation graphs](https://developer.android.com/guide/navigation/navigation-nested-graphs),
...
[supports deep linking](https://developer.android.com/topic/libraries/architecture/navigation/navigation-deep-link)
