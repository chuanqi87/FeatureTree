...
Links for your [Android Instant Apps](https://developer.android.com/topic/instant-apps).
...
specific description, see [differences between deep links and app links](https://developer.android.com/training/app-links/verify-android-applinks#the-difference).
...
* Only one instant app can be declared for each website domain. (This is
  ...
  [associate a website with multiple apps](https://developer.android.com/training/app-links/verify-android-applinks#multiple-apps).)
...
* You must set `autoVerify="true"` in at least one intent filter in both the
  instant and the installable app. (See how to [enable automatic verification](https://developer.android.com/training/app-links/verify-android-applinks#config-verify).)
* You must publish one `assetlinks.json` for each domain (and subdomain
  ...
  [support app linking for multiple hosts](https://developer.android.com/training/app-links/verify-android-applinks#multi-host)).
...
* Use of wildcards in your intent filter's host attribute is not recommended.
  (See how to [support app linking from multiple subdomains](https://developer.android.com/training/app-links/verify-android-applinks#multi-subdomain).)
