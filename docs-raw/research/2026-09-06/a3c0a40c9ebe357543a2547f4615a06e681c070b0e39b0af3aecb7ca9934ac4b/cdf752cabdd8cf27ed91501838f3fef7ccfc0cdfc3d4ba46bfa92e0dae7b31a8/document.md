...
![](https://media:901787638268625489 "点击放大")  
...
![](https://media:901787638269052490 "点击放大")  
...
![](https://media:901787638269256491 "点击放大")  
![](https://media:901787638269284492)  
对于不提供Web页面的应用，建议开启直达应用市场功能，避免因无法访问内容而造成体验断裂，具体可参考：[通过直达应用市场能力跳转至应用市场下载详情页](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/applinking-direct-to-ag)。  
...
![](https://media:901787638269319493 "点击放大")

碰一碰视频分享时序图如下：

![](https://media:901787638269366494 "点击放大")  
![](https://media:901787638269391495)  
...
![](https://media:901787638269416496)  
...
![](https://media:901787638269446497)  
...
![](https://media:901787638269486498 "点击放大")  
...
2. 配置直达应用市场与延迟链接 为提升用户未安装应用时的体验，可配置直达应用市场功能，引导用户下载安装应用，具体可参考：[通过直达应用市场能力跳转至应用市场下载详情页](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/applinking-direct-to-ag)。配置完成后，当对端收到源端分享的App Linking链接时，若设备未安装目标应用，系统将直接跳转至应用市场的应用详情页，支持一键下载安装。

   ![](https://media:901787638269768499 "点击放大")
   ...
   ![](https://media:901787638270088500 "点击放大")
...
3. Web页面开发与部署 当应用未安装且未配置直达应用市场时，系统会打开浏览器加载视频播放Web页面来播放视频，保证应用在未安装的情况下也能体验播放视频功能，特别是与[延迟链接](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/applinking-deferredlink)结合使用，详细请参见[Web页面开发与部署（可选）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/social-sharing-redirection#web页面开发与部署可选)。

![](https://media:901787638270222501 "点击放大")  
