...
The [Camera2 APIs](https://developer.android.com/reference/android/hardware/camera2/package-summary) support
...
For more information, see [HDR formats](https://developer.android.com/training/camera2/hdr-video-capture#hdr_formats).
...
* Has a 10-bit or higher capable camera sensor. For more information about HDR
  Support, see [Check for HDR support](https://developer.android.com/training/camera2/hdr-video-capture#check_for_hdr_support).
...
referenced in the [`CaptureRequest`](https://developer.android.com/training/camera2/capture-sessions-requests#repeating-capture-requests), such as a display or
...
Use the [`CameraManager`](https://developer.android.com/reference/android/hardware/camera2/CameraManager) [`getCameraCharacteristics()`](https://developer.android.com/reference/android/hardware/camera2/CameraManager#getCameraCharacteristics(java.lang.String)) method to obtain a
...
Use [`setDynamicRangeProfile()`](https://developer.android.com/reference/android/hardware/camera2/params/OutputConfiguration#setDynamicRangeProfile(long)) to provide the stream’s [`OutputConfiguration`](https://developer.android.com/reference/android/hardware/camera2/params/OutputConfiguration)
with a device-supported HDR profile, which is then passed
to the [`CameraCaptureSession`](https://developer.android.com/reference/android/hardware/camera2/CameraCaptureSession)
upon creation.
See the [list](https://developer.android.com/reference/android/hardware/camera2/params/DynamicRangeProfiles#constants_1) of supported HDR profiles.
...
repeating
[`CaptureRequest`](https://developer.android.com/training/camera2/capture-sessions-requests#repeating-capture-requests)
...
use [`MediaCodec`](https://developer.android.com/reference/android/media/MediaCodec#createPersistentInputSurface()).

First, get the [`OutputSurface`](https://developer.android.com/reference/kotlin/androidx/camera/core/impl/OutputSurface),
which maps to a buffer that stores raw video data.
For `MediaCodec`,
use [`createInputSurface()`](https://developer.android.com/reference/android/media/MediaCodec#createInputSurface()).

To initialize `MediaCodec`, an app must create a
[`MediaFormat`](https://developer.android.com/reference/android/media/MediaFormat) with a specified
...
Starting in Android 13, camera devices with 10-bit output capabilities
must support HLG10 for HDR capture and
[playback](https://source.android.com/devices/tech/display/hdr).
In addition, device makers can enable any HDR format of their choosing
using the [HDR capture architecture](https://developer.android.com/training/camera2/hdr-video-capture#hdr_capture_architecture).

The following table sums up the available HDR formats and their capabilities
for HDR video capture.
...
For a working app with HDR video capture functionality, see the
