...
[Cloud Firestore Security Rules](https://firebase.google.com/docs/firestore/enterprise/security/get-started) to secure your data when using
the
Android, Apple, and Web client libraries.
