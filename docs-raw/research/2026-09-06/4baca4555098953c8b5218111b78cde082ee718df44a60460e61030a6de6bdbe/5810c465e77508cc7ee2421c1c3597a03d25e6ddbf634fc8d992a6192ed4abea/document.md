...
![](https://media:201787906829438113)  
* 模块维护策略：
...
![](https://media:201787906829474114)  
除Lite Wearable外，从API version 8开始，建议使用[ACCELEROMETER](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_accelerometerdeprecated)替代。
...
![](https://media:201787906829517115)  
除Lite Wearable外，从API version 8开始，建议使用[ACCELEROMETER](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_accelerometerdeprecated)替代。
...
![](https://media:201787906829553116)  
除Lite Wearable外，从API version 8开始，建议使用[ORIENTATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_orientationdeprecated)替代。
...
![](https://media:201787906829735117)  
除Lite Wearable外，从API version 8开始，建议使用[ORIENTATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_orientationdeprecated)替代。
...
![](https://media:201787906829775118)  
从 API version 3开始支持，从API version 8开始废弃。除Lite Wearable外，建议使用[PROXIMITY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_proximitydeprecated)替代。
...
![](https://media:201787906829857119)  
除Lite Wearable外，从API version 8开始，建议使用[PROXIMITY](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_proximitydeprecated)替代。
...
![](https://media:201787906829889120)  
除Lite Wearable外，从API version 8开始，建议使用[AMBIENT_LIGHT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_ambient_lightdeprecated)替代。
...
![](https://media:201787906829926121)  
除Lite Wearable外，从API version 8开始，建议使用[AMBIENT_LIGHT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_ambient_lightdeprecated)替代。
...
![](https://media:201787906829954122)  
除Lite Wearable外，从API version 8开始，建议使用[PEDOMETER](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_pedometerdeprecated)替代。
...
![](https://media:201787906829983123)  
除Lite Wearable外，从API version 8开始，建议使用[PEDOMETER](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_pedometerdeprecated)替代。
...
![](https://media:201787906830018124)  
除Lite Wearable外，从API version 8开始，建议使用[BAROMETER](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_barometerdeprecated)替代。
...
![](https://media:201787906830045125)  
除Lite Wearable外，从API version 8开始，建议使用[BAROMETER](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_barometerdeprecated)替代。
...
![](https://media:201787906830083126)  
除Lite Wearable外，从API version 8开始，建议使用[HEART_RATE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_heart_ratedeprecated)替代。
...
![](https://media:201787906830111127)  
除Lite Wearable外，从API version 8开始，建议使用[HEART_RATE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_heart_ratedeprecated)替代。
...
![](https://media:201787906830144128)  
除Lite Wearable外，从API version 8开始，建议使用[WEAR_DETECTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_wear_detectiondeprecated)替代。
...
![](https://media:201787906830171129)  
除Lite Wearable外，从API version 8开始，建议使用[WEAR_DETECTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_wear_detectiondeprecated)替代。
...
![](https://media:201787906830200130)  
除Lite Wearable外，从API version 8开始，建议使用[WEAR_DETECTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_wear_detectiondeprecated)替代。
...
![](https://media:201787906830247131)  
除Lite Wearable外，从API version 8开始，建议使用[ORIENTATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_orientationdeprecated)替代。
...
![](https://media:201787906830296132)  
除Lite Wearable外，从API version 8开始，建议使用[ORIENTATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_orientationdeprecated)替代。
...
![](https://media:201787906830325133)  
除Lite Wearable外，从API version 8开始，建议使用[GYROSCOPE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoronsensortypesensor_type_id_gyroscopedeprecated)替代。
...
![](https://media:201787906830359134)  
除Lite Wearable外，从API version 8开始，建议使用[GYROSCOPE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensoroffsensortypesensor_type_id_gyroscopedeprecated)替代。
