...
- Use gesture recognizers to track the touches; see [Handling UIKit gestures](/documentation/UIKit/handling-uikit-gestures).
- Track the touches directly in your [`UIView`](/documentation/UIKit/UIView) subclass; see [Handling touches in your view](/documentation/UIKit/handling-touches-in-your-view).
