...
[User Guide](https://developer.android.com/topic/security/data)  [Code Sample](https://github.com/android/security-samples)
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:618647%20status:open)
...
* Fixed issue retrieving key/values associated with shared preferences from
  [`getAll()`](https://developer.android.com/reference/androidx/security/crypto/EncryptedSharedPreferences#getAll()).
