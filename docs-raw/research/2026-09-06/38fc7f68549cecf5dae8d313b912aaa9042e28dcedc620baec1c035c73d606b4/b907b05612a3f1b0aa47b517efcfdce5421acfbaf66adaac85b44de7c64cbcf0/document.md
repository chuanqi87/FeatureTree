...
![](https://media:201787906864220634)  
...
![](https://media:201787906864247635)  
...
定义不同的NFC卡模拟类型。  
![](https://media:201787906864285636)  
...
是否支持某种类型的卡模拟。  
![](https://media:201787906864483637)  
从 API version 6 开始支持，从 API version 9 开始废弃，建议使用[hasHceCapability](#cardemulationhashcecapability9)替代。
...
#### cardEmulation.hasHceCapability^9+^
...
#### cardEmulation.isDefaultService^9+^
...
![](https://media:201787906864504638)  
...
![](https://media:201787906864532639)  
...
发送APDU数据到对端读卡设备。  
![](https://media:201787906864557640)  
