...
levels. See [Control hardware acceleration](https://developer.android.com/topic/performance/hardware-accel#controlling).

If your application performs custom drawing, test your application on actual hardware devices
with hardware acceleration turned on to find any problems. The [Support for drawing operations](https://developer.android.com/topic/performance/hardware-accel#drawing-support) section describes known issues with
...
the view level. View layers have other functions besides disabling hardware acceleration. See [View layers](https://developer.android.com/topic/performance/hardware-accel#layers) for more information about their uses.
...
still take advantage of hardware acceleration everywhere else. See [Control hardware acceleration](https://developer.android.com/topic/performance/hardware-accel#controlling) for more information on how to enable
