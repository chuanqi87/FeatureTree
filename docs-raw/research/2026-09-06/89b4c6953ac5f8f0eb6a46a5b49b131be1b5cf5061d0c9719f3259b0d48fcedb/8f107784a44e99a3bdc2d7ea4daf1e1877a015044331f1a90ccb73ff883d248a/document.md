...
* Group compatible use cases together into more than one
  [fragment](https://developer.android.com/reference/androidx/fragment/app/Fragment) and then switch between
  fragments
...
* When extensions are enabled, only the `ImageCapture` and `Preview`
  ...
  [Extension reference doc](https://developer.android.com/reference/androidx/camera/extensions/ExtensionsManager)
  for details.
