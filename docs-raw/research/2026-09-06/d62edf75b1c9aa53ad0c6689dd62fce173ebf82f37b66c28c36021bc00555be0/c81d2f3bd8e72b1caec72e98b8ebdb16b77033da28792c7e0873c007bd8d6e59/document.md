...
at the same time, as described in [Hiding the Status Bar](https://developer.android.com/training/system-ui/status).
...
* Once the flags have been cleared, your app needs to reset them if you
  want to hide the bars again. See [Responding to UI Visibility Changes](https://developer.android.com/training/system-ui/visibility) for a
...
discussion of this topic, see the [Hiding the Status Bar](https://developer.android.com/training/system-ui/status#behind) lesson.
