# Test your app's accessibility (Views)

[Concepts and Jetpack Compose implementationarrow\_forward](https://developer.android.com/guide/topics/ui/accessibility/testing)
...
* **Testing using analysis tools**: use tools to discover opportunities to
...
![Demo of the Accessibility Scanner](/static/studio/images/releases/atf-scanner.gif)
...
**Note:** Keep in mind that the Android Accessibility Test Framework in Android
Studio can't detect issues that occur when the app is running on a device.
...
![An image showing Android Studio reporting a missing content description on some images.](/static/images/guide/topics/ui/accessibility/studio-missing-content-description.svg)


**Figure 2.** Message in Android Studio showing missing
