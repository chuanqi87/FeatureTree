...
To set progress, use the <doc://com.apple.documentation/documentation/Foundation/ProgressReporting> protocol that [`BGContinuedProcessingTask`](/documentation/BackgroundTasks/BGContinuedProcessingTask) conforms to:
