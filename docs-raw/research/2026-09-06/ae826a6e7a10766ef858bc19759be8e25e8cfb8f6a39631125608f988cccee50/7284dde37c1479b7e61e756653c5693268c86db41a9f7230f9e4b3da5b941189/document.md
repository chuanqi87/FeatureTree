...
[`SecurityException`](https://developer.android.com/reference/java/lang/SecurityException) occurs.
...
[`openRawResource()`](https://developer.android.com/reference/android/content/res/Resources#openRawResource(int)),
passing in the filename prefixed with `R.raw` as the resource ID. This method
returns an [`InputStream`](https://developer.android.com/reference/java/io/InputStream) that you can use to
...
**Note:** [`dataDir`](https://developer.android.com/reference/kotlin/android/content/pm/ApplicationInfo#datadir)
...
[internal storage](https://developer.android.com/training/data-storage/app-specific#internal).
...
[`IOException`](https://developer.android.com/reference/java/io/IOException) if one occurs. You may need to
