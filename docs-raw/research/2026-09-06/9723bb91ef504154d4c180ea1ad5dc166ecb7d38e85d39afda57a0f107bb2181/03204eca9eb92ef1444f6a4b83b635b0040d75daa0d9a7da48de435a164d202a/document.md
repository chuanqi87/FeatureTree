...
![](https://media:201787906889380009)  
...
![](https://media:201787906889412010)  
...
![](https://media:201787906889496011)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
#### isOsAccountConstraintEnabled^11+^
...
![](https://media:201787906889521012)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
![](https://media:201787906889545013)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
![](https://media:201787906889569014)  
...
![](https://media:201787906889776015)  
从API version 9开始支持，从API version 11开始废弃，建议使用[isOsAccountUnlocked](#isosaccountunlocked11)替代。
...
![](https://media:201787906889802016)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
![](https://media:201787906889828017)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
#### getOsAccountLocalIdForUidSync^10+^
...
#### getOsAccountLocalIdForDomain^9+^
...
![](https://media:201787906889852018)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
![](https://media:201787906889877019)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
#### getActivatedOsAccountLocalIds^9+^
...
![](https://media:201787906889898020)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。

需要权限： ohos.permission.MANAGE_LOCAL_ACCOUNTS或ohos.permission.GET_LOCAL_ACCOUNTS^10+^，以上权限仅系统应用可申请。
...
![](https://media:201787906889923021)  
从API version 9开始支持，从API version 11开始废弃，替代方法仅向系统应用开放。
...
#### queryDistributedVirtualDeviceId^9+^
...
#### getOsAccountLocalIdForSerialNumber^9+^
...
#### getSerialNumberForOsAccountLocalId^9+^
...
判断是否支持多系统账号。使用callback异步回调。  
![](https://media:201787906889958022)  
...
判断是否支持多系统账号。使用Promise异步回调。  
![](https://media:201787906889988023)  
...
判断指定系统账号是否处于激活状态。使用callback异步回调。  
![](https://media:201787906890018024)  
...
判断指定系统账号是否处于激活状态。使用Promise异步回调。  
![](https://media:201787906890046025)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
判断指定系统账号是否具有指定约束。使用callback异步回调。  
![](https://media:201787906890078026)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
判断指定系统账号是否具有指定约束。使用Promise异步回调。  
![](https://media:201787906890103027)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
检查当前系统账号是否为测试账号。使用callback异步回调。  
![](https://media:201787906890140028)  
...
检查当前系统账号是否为测试账号。使用Promise异步回调。  
![](https://media:201787906890166029)  
...
![](https://media:201787906890189030)  
...
检查指定系统账号是否已验证。使用callback异步回调。  
![](https://media:201787906890215031)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
检查指定系统账号是否已验证。使用Promise异步回调。  
![](https://media:201787906890244032)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
获取已创建的系统账号数量。使用callback异步回调。  
![](https://media:201787906890270033)  
...
获取已创建的系统账号数量。使用Promise异步回调。  
![](https://media:201787906890297034)  
...
获取当前进程所属的系统账号ID。使用callback异步回调。  
![](https://media:201787906890323035)  
...
获取当前进程所属的系统账号ID。使用Promise异步回调。  
![](https://media:201787906890368036)  
...
根据uid查询对应的系统账号ID。使用callback异步回调。  
![](https://media:201787906890391037)  
...
根据uid查询对应的系统账号ID。使用Promise异步回调。  
![](https://media:201787906890416038)  
...
![](https://media:201787906890441039)  
...
根据域账号信息，获取与其关联的系统账号的账号ID。使用Promise异步回调。  
![](https://media:201787906890466040)  
...
获取指定系统账号的全部约束。使用callback异步回调。  
![](https://media:201787906890489041)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
获取指定系统账号的全部约束。使用Promise异步回调。  
![](https://media:201787906890511042)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
查询当前处于激活状态的系统账号的ID列表。使用callback异步回调。  
![](https://media:201787906890540043)  
...
![](https://media:201787906890563044)  
...
查询当前进程所属的系统账号的信息。使用callback异步回调。  
![](https://media:201787906890590045)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
查询当前进程所属的系统账号的信息。使用Promise异步回调。  
![](https://media:201787906890614046)  
从API version 7开始支持，从API version 9开始废弃，替代方法仅向系统应用开放。
...
查询当前进程所属的系统账号的账号类型。使用callback异步回调。  
![](https://media:201787906890640047)  
...
查询当前进程所属的系统账号的账号类型。使用Promise异步回调。  
![](https://media:201787906890678048)  
...
获取分布式虚拟设备ID。使用callback异步回调。  
![](https://media:201787906890701049)  
...
获取分布式虚拟设备ID。使用Promise异步回调。  
![](https://media:201787906890722050)  
...
通过SN码查询与其关联的系统账号的账号ID。使用callback异步回调。  
![](https://media:201787906890745051)  
...
通过SN码查询与其关联的系统账号的账号ID。使用Promise异步回调。  
![](https://media:201787906890771052)  
...
通过系统账号ID获取与该系统账号关联的SN码。使用callback异步回调。  
![](https://media:201787906890795053)  
...
通过系统账号ID获取与该系统账号关联的SN码。使用Promise异步回调。  
![](https://media:201787906890820054)  
...
#### getForegroundOsAccountLocalId^15+^
...
#### DomainAccountManager^18+^

域账号管理类。  

#### updateAccountInfo^18+^
...
|isUnlocked^11+^|boolean|否|否|账号是否已解锁（EL2级别目录是否解密）。true表示指定账号已解锁；false表示指定账号未解锁。|
|photo^8+^|string|否|否|系统账号头像，默认为空。|
|createTime^8+^|number|否|否|系统账号创建时间，以Unix时间戳格式表示，单位为s。|
|lastLoginTime^8+^|number|否|否|系统账号最后一次登录时间，以Unix时间戳格式表示，单位为s。|
|serialNumber^8+^|number|否|否|系统账号SN码。|
...
|isActivated^11+^|boolean|否|否|系统账号是否激活。true表示指定账号已激活；false表示指定账号未激活。|
|isCreateCompleted^8+^|boolean|否|否|系统账号创建是否完整。true表示指定账号已创建完整；false表示指定账号未创建完整。|
...
|domainInfo^8+^|[DomainAccountInfo](#domainaccountinfo8)|否|否|域账号信息，默认为空。|
