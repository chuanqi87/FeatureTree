...
|Unique subscribers     |Only available for application metrics. ![](spacer) A snapshot count of unique devices subscribed to at least one channel for your app. APNs records subscription snapshots throughout the day and reports the highest value for each day.|
