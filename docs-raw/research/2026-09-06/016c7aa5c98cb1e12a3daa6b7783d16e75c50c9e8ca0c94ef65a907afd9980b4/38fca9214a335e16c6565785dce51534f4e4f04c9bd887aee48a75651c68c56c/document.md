...
* 方法一：在命令提示符窗口中，输入hdc shell top命令，查看当前系统的top进程的CPU占用率。如果av_codec_service进程的CPU负载率超过 5%，则说明视频硬解码已启用。 ![](https://media:901787638382681711 "点击放大")
...
* 方法二：[通过DevEco Studio Profiler抓取systrace](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-insight-session-time)
  ...
  通过systrace确认av_codec_service进程的负载，如下图所示。业务频繁唤醒且有实际函数运行，说明视频处于硬解码状态。

![](https://media:901787638382724712 "点击放大")
