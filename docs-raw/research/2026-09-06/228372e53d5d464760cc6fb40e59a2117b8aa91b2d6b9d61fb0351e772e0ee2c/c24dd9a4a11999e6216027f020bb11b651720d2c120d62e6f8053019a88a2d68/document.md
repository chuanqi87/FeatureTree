...
permissions, known as [install-time permissions](https://developer.android.com/training/permissions#install-time), are
automatically granted when your app is installed. Other permissions, known as
[runtime permissions](https://developer.android.com/training/permissions#runtime), require your app to go a step further and
