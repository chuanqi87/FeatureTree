...
Create an instance of [`CLBackgroundActivitySession`](/documentation/CoreLocation/CLBackgroundActivitySession-3mzv3) to start a background activity session so that you can receive location updates. It’s your responsibility to communicate that location updates will arrive before going to the background, and handle updates as they arrive.

Create a [`CLServiceSession`](/documentation/CoreLocation/CLServiceSession-pt7n) requiring the relevant form of authorization  ([`CLServiceSession.AuthorizationRequirement.whenInUse`](/documentation/CoreLocation/CLServiceSession-pt7n/AuthorizationRequirement/whenInUse) or [`CLServiceSession.AuthorizationRequirement.always`](/documentation/CoreLocation/CLServiceSession-pt7n/AuthorizationRequirement/always)). Create the session while your app is in the foreground. If your app terminates, you must recreate the [`CLServiceSession`](/documentation/CoreLocation/CLServiceSession-pt7n) immediately upon launch in the background.

Core Location sets When in Use authorization implicitly when you process events from [`CLMonitor`](/documentation/CoreLocation/CLMonitor-2r51v), [`CLLocationUpdate`](/documentation/CoreLocation/CLLocationUpdate), or use a [`CLBackgroundActivitySession`](/documentation/CoreLocation/CLBackgroundActivitySession-3mzv3). The exception is if you set the `NSLocationRequireExplicitServiceSession` in your app’s `Info.plist`.
