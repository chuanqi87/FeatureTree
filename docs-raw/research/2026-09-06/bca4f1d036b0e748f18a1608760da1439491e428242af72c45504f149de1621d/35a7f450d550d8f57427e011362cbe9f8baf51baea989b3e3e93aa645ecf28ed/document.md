...
![](https://media:201787906273371260)  
...
![](https://media:201787906273396261)  
...
![](https://media:201787906273420262)  
...
![](https://media:201787906273444263)  
当前注册监听接口，不支持在on监听的回调方法里，调用off注销回调。
...
![](https://media:201787906273469264)  
当前注册监听接口，不支持在on监听的回调方法里，调用off注销回调。
...
![](https://media:201787906273503265)  
当前注册监听接口，不支持在on监听的回调方法里，调用off注销回调。
...
![](https://media:201787906273530266)  
当前注册监听接口，不支持在on监听的回调方法里，调用off注销回调。
...
![](https://media:201787906273558267)  
当前注册监听接口，不支持在on监听的回调方法里，调用off注销回调。
...
![](https://media:201787906273585268)  
当前注册监听接口，不支持在on监听的回调方法里，调用off注销回调。
...
![](https://media:201787906273613269)  
当前注册监听接口，不支持在on监听的回调方法里，调用off注销回调。
...
![](https://media:201787906273640270)  
...
注销拍照开始的监听。  
![](https://media:201787906273671271)  
