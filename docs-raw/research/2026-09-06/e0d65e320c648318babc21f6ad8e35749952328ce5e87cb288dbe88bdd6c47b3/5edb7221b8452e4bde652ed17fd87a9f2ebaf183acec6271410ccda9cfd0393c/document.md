...
Some codecs may be available in both hardware and software implementations. Use the [`kAudioFormatProperty_Encoders`](/documentation/AudioToolbox/kAudioFormatProperty_Encoders) and [`kAudioFormatProperty_Decoders`](/documentation/AudioToolbox/kAudioFormatProperty_Decoders) constants to determine whether a given codec is present, and whether it is hardware or software-based.
...
See also [Audio Codec Component Constants](/documentation/AudioToolbox/1494086-audio-codec-component-constants) and [Audio Codec Manufacturer and Implementation Types](/documentation/AudioToolbox/1620448-audio-codec-manufacturer-and-imp).

## Topics

### Constants

[`kAudioFormatProperty_HardwareCodecCapabilities`](/documentation/AudioToolbox/kAudioFormatProperty_HardwareCodecCapabilities)
