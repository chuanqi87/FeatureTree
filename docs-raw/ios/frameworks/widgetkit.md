...
![A conceptual image that shows a small widget on iPhone, a rectangular widget on Apple Watch, and a small widget on the Mac desktop.](https://developer.apple.com/tutorials/images/com.apple.WidgetKit/widgetkit-hero@2x.png)
...
[API Reference\\
Live Activities](https://developer.apple.com/documentation/widgetkit/liveactivities-collection)
...
[API Reference\\
SwiftUI views for widgets](https://developer.apple.com/documentation/widgetkit/swiftui-views)
...
[API Reference\\
Preview macros](https://developer.apple.com/documentation/widgetkit/preview-macros)
