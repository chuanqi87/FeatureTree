...
- A silent notification (see [Pushing background updates to your App](/documentation/UserNotifications/pushing-background-updates-to-your-app)).
...
> Note:
> You declare actionable notification types at launch time at the same time you declare your app’s supported categories. For more information, see <doc://com.apple.usernotifications/documentation/UserNotifications/declaring-your-actionable-notification-types>.

You handle selected actions from the delegate object of the shared [`UNUserNotificationCenter`](/documentation/UserNotifications/UNUserNotificationCenter) object. When the user selects an action, the system launches your app in the background and calls the delegate’s [`userNotificationCenter(_:didReceive:withCompletionHandler:)`](/documentation/UserNotifications/UNUserNotificationCenterDelegate/userNotificationCenter(_:didReceive:withCompletionHandler:)) method. Match the value in the [`actionIdentifier`](/documentation/UserNotifications/UNNotificationResponse/actionIdentifier) property of the response object to one of your app’s actions or a system-defined action. The system reports special actions when the user dismisses the notification or launches your app.
...
When a notification arrives, the system calls the [`userNotificationCenter(_:willPresent:withCompletionHandler:)`](/documentation/UserNotifications/UNUserNotificationCenterDelegate/userNotificationCenter(_:willPresent:withCompletionHandler:)) method of the [`UNUserNotificationCenter`](/documentation/UserNotifications/UNUserNotificationCenter) object’s delegate. Use that method to process the notification and let the system know how you want it to proceed. Listing 2 shows a version of this method for a calendar app. When a meeting invitation arrives, the app calls its custom `queueMeetingForDelivery` method to show the new invitation in the app’s interface. The app also asks the system to play the notification’s sound by passing the [`sound`](/documentation/UserNotifications/UNNotificationPresentationOptions/sound) value to the completion handler. For other notification types, the method silences the notification.
