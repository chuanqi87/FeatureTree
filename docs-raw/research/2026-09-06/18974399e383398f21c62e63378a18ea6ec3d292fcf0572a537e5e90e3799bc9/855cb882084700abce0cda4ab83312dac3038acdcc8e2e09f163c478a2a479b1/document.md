...
|:-------|:----------------------------------------|:-|:-----------------------------------------------------------|
|type|string|是|固定填写"squeeze"字符串，表示手写笔笔身轻捏事件。|
|receiver|Callback\<[SqueezeEvent](#squeezeevent)\>|否|回调函数，需要取消订阅的手写笔轻捏事件对象，需与订阅时传入的回调函数是同一个。若不设置此参数，则取消订阅所有的轻捏事件。|
...
|:-------|:--------------------------------------------|:-|:-----------------------------------------------------------|
|type|string|是|固定填写"doubleTap"字符串，表示手写笔笔身双击事件。|
|receiver|Callback\<[DoubleTapEvent](#doubletapevent)\>|否|回调函数，需要取消订阅的手写笔双击事件对象，需与订阅时传入的回调函数是同一个。若不设置此参数，则取消订阅所有的双击事件。|
...
|参数名|类型|必填|说明|
|:-------|:----------------------------------------------------|:-|:------------------|
|receiver|Callback\<[AccelerometerEvent](#accelerometerevent)\>|是|回调函数，返回手写笔加速度传感器数据。|
...
|参数名|类型|必填|说明|
|:-------|:----------------------------------------------------|:-|:--------------------------------------------------------------|
|receiver|Callback\<[AccelerometerEvent](#accelerometerevent)\>|否|回调函数，需要取消订阅的加速度数据回调对象，需与订阅时传入的回调函数是同一个。若不设置此参数，则取消订阅所有的加速度数据回调。|
...
|参数名|类型|必填|说明|
|:-------|:--------------------------------------------|:-|:------------------|
|receiver|Callback\<[GyroscopeEvent](#gyroscopeevent)\>|是|回调函数，返回手写笔陀螺仪传感器数据。|
...
|参数名|类型|必填|说明|
|:-------|:--------------------------------------------|:-|:--------------------------------------------------------------|
|receiver|Callback\<[GyroscopeEvent](#gyroscopeevent)\>|否|回调函数，需要取消订阅的陀螺仪数据回调对象，需与订阅时传入的回调函数是同一个。若不设置此参数，则取消订阅所有的陀螺仪数据回调。|
...
|参数名|类型|必填|说明|
|:-------|:--------------------------------------|:-|:----------------------|
|receiver|Callback\<[SensorEvent](#sensorevent)\>|是|回调函数，返回手写笔加速度和陀螺仪传感器数据。|
...
|参数名|类型|必填|说明|
|:-------|:--------------------------------------|:-|:--------------------------------------------------------------|
|receiver|Callback\<[SensorEvent](#sensorevent)\>|否|回调函数，需要取消订阅的传感器数据回调对象，需与订阅时传入的回调函数是同一个。若不设置此参数，则取消订阅所有的传感器数据回调。|
