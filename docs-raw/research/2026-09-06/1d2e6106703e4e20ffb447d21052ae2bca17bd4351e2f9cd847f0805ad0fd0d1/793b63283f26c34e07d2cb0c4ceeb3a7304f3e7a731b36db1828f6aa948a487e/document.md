...
![](https://media:201787905841737101 "点击放大")  
...
|接口名|描述|
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------|
|[MapSignalParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#mapsignalparams)|信号路线的属性。|
|[addSignalLine](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#addsignalline)(params: mapCommon.[MapSignalParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#mapsignalparams)): Promise\<[MapSignalLine](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapsignalline)\>|新增信号路线。|
|[MapSignalLine](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapsignalline)|信号路线管理对象。|

#### 开通信号预测能力

使用信号路线功能需要先开通信号预测能力。  
![](https://media:201787905841771102)  
权限申请入口目前仅针对企业开发者开放，个人开发者不可见。

1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)网站，选择"开发与服务"。

   ![](https://media:201787905841806103)
2. 在项目列表中找到需要开通"信号预测能力"的应用。

   ![](https://media:201787905841849104)
3. 进入"开放能力管理"页签，找到"地图服务"开关下的"信号预测能力"，点击"申请"。

   ![](https://media:201787905841922105)
4. 确认您已满足开通信号预测能力的所有条件后，点击"下一步"。

   ![](https://media:201787905841950106)
5. 填写申请原因。

   ![](https://media:201787905841980107)  
   申请原因填写模板：
   * 应用介绍：说明应用类型，例如XXX应用属于XXX类型的应用。
   * 使用场景：说明权限使用场景，例如在XXX场景下，需要使用XX能力。
   * 申请用途：描述该权限的用途，例如用户使用XXX功能后，进行XXX操作，提供XXX服务。

   ![](https://media:201787905842021108)
...
![](https://media:201787905842065109)  
