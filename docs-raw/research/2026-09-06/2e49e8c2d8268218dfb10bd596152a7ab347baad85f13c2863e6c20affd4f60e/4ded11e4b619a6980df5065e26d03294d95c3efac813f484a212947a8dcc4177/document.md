...
your UI components, as discussed in [Recomposition](https://developer.android.com/jetpack/compose/mental-model#recomposition).
...
* **Properties:** This function is fast,
  ...
  properties, for reasons discussed in [Recomposition](https://developer.android.com/jetpack/compose/mental-model#recomposition).
