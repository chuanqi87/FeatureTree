...
[Avoid duplicate notifications](https://developer.android.com/about/versions/13/features/copy-paste#duplicate-notifications)
section.
...
[recommendations for this](https://developer.android.com/about/versions/13/features/copy-paste#Feedback) in this document.
...
described in the [Coerce the clipboard to text](https://developer.android.com/about/versions/13/features/copy-paste#CoerceToText) section.
...
3. Copy the data to a new `ClipData` object:
   ...
   * **For a URI**
     ...
     [Encoding an identifier on the URI](https://developer.android.com/about/versions/13/features/copy-paste#Encoding) section.
...
[Receive rich content](https://developer.android.com/guide/topics/input/receive-rich-content) document to add
...
* Accesses
  [`ClipData`](https://developer.android.com/reference/android/content/ClipData) from your own app.
...
* Retrieves metadata for the clip object, such as by calling
  [`getPrimaryClipDescription()`](https://developer.android.com/reference/android/content/ClipboardManager#getPrimaryClipDescription())
...
The [Paste data from a content URI](https://developer.android.com/about/versions/13/features/copy-paste#PasteContentUri) section describes how to get a
...
1. Set up a content URI for the data stream you are putting on the clipboard. Options
   ...
   * Encode an identifier for the data stream onto the URI, as described in the
     [Encode an identifier on the URI](https://developer.android.com/about/versions/13/features/copy-paste#Encoding) section, and then maintain a
