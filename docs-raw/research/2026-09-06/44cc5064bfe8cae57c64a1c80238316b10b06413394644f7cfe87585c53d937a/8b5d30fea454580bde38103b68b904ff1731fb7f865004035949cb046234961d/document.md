...
> Session 10025: [Meet Push Notifications Console](https://developer.apple.com/videos/play/wwdc2023/10025/)
> Session 9162: [Broadcast updates to your Live Activities](https://developer.apple.com/videos/play/wwdc2024/9162/)

> Tip:
> Refer to <doc://com.apple.usernotifications/documentation/UserNotifications/viewing-the-status-of-push-notifications-using-metrics-and-apns>.
...
You can use the Device Token Validator to determine the validity of the device token. To verify a device token associated with a bundle ID, you need to select the respective bundle ID in the dashboard. For more information on getting a device token, see [Registering your app with APNs](/documentation/UserNotifications/registering-your-app-with-apns).
