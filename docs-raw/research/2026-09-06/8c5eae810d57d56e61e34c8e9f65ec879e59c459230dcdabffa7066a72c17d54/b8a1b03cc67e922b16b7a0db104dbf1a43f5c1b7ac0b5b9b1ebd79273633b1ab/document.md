...
- If possible, run the packet trace on one of the machines involved in the communication — including using RVI to record an iOS packet trace. That’s the easiest solution. See [Recording a Packet Trace](/documentation/Network/recording-a-packet-trace) for instructions.
