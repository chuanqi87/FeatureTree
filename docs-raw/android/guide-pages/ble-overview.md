[Skip to main content](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview#main-content)
...
- [English](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview)
- [Deutsch](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=de)
- [Español – América Latina](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=es-419)
- [Français](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=fr)
- [Indonesia](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=id)
- [Italiano](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=it)
- [Polski](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=pl)
- [Português – Brasil](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=pt-br)
- [Tiếng Việt](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=vi)
- [Türkçe](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=tr)
- [Русский](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=ru)
- [עברית](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=he)
- [العربيّة](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=ar)
- [فارسی](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=fa)
- [हिंदी](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=hi)
- [বাংলা](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=bn)
- [ภาษาไทย](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=th)
- [中文 – 简体](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=zh-cn)
- [中文 – 繁體](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=zh-tw)
- [日本語](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=ja)
- [한국어](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview?hl=ko)

[Android Studio](https://developer.android.com/studio)

[Sign in](https://developer.android.com/_d/signin?continue=https%3A%2F%2Fdeveloper.android.com%2Fdevelop%2Fconnectivity%2Fbluetooth%2Fble%2Fble-overview&prompt=select_account)
...
- On this page
- [The basics](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview#basics)
- [Key terms and concepts](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview#terms)
  - [Roles and responsibilities](https://developer.android.com/develop/connectivity/bluetooth/ble/ble-overview#roles)
...
# Bluetooth Low Energy    Stay organized with collections      Save and categorize content based on your preferences.
...
In contrast to [classic Bluetooth](https://developer.android.com/develop/connectivity/bluetooth),
...
[declare several permissions](https://developer.android.com/develop/connectivity/bluetooth/bt-permissions)
...
[scan for nearby BLE devices](https://developer.android.com/develop/connectivity/bluetooth/ble/find-ble-devices).
Once a device is found, the capabilities of the BLE device are discovered by
[connecting to the GATT server on the BLE device](https://developer.android.com/develop/connectivity/bluetooth/ble/connect-gatt-server).
Once a connection is made,
[data can be transferred with the connected device](https://developer.android.com/develop/connectivity/bluetooth/ble/transfer-ble-data)
...
- **Profiles**The **Bluetooth SIG** defines many
...
- **Attribute Protocol (ATT)**GATT is built on top of the Attribute Protocol (ATT). This is also referred to
...
ID used to uniquely identify information. The _attributes_ transported by ATT
are formatted as _characteristics_ and _services_.
- **Characteristic**A characteristic contains a single value and 0-n descriptors that describe the
characteristic's value. A characteristic can be thought of as a type,
analogous to a class.
- **Descriptor**Descriptors are defined attributes that describe a characteristic value. For
...
- **Service**A service is a collection of characteristics. For example, you could have a
...
- The phone—the _central_ device—actively scans for BLE devices. The activity
tracker—the _peripheral_ device—advertises and waits to receive a request for
connection.
...
on the phone sends requests for data, so it acts as the _GATT client_. The
activity tracker fulfills those requests, so it acts as the _GATT server_.


An alternative design of the app might involve the phone playing the GATT server
role instead. See
[`BluetoothGattServer`](https://developer.android.com/reference/android/bluetooth/BluetoothGattServer) for
more information.
