[Skip to main content](https://developer.android.com/guide/fragments/communicate#main-content)
...
- [English](https://developer.android.com/guide/fragments/communicate)
- [Deutsch](https://developer.android.com/guide/fragments/communicate?hl=de)
- [Español – América Latina](https://developer.android.com/guide/fragments/communicate?hl=es-419)
- [Français](https://developer.android.com/guide/fragments/communicate?hl=fr)
- [Indonesia](https://developer.android.com/guide/fragments/communicate?hl=id)
- [Italiano](https://developer.android.com/guide/fragments/communicate?hl=it)
- [Polski](https://developer.android.com/guide/fragments/communicate?hl=pl)
- [Português – Brasil](https://developer.android.com/guide/fragments/communicate?hl=pt-br)
- [Tiếng Việt](https://developer.android.com/guide/fragments/communicate?hl=vi)
- [Türkçe](https://developer.android.com/guide/fragments/communicate?hl=tr)
- [Русский](https://developer.android.com/guide/fragments/communicate?hl=ru)
- [עברית](https://developer.android.com/guide/fragments/communicate?hl=he)
- [العربيّة](https://developer.android.com/guide/fragments/communicate?hl=ar)
- [فارسی](https://developer.android.com/guide/fragments/communicate?hl=fa)
- [हिंदी](https://developer.android.com/guide/fragments/communicate?hl=hi)
- [বাংলা](https://developer.android.com/guide/fragments/communicate?hl=bn)
- [ภาษาไทย](https://developer.android.com/guide/fragments/communicate?hl=th)
- [中文 – 简体](https://developer.android.com/guide/fragments/communicate?hl=zh-cn)
- [中文 – 繁體](https://developer.android.com/guide/fragments/communicate?hl=zh-tw)
- [日本語](https://developer.android.com/guide/fragments/communicate?hl=ja)
- [한국어](https://developer.android.com/guide/fragments/communicate?hl=ko)

[Android Studio](https://developer.android.com/studio)

[Sign in](https://developer.android.com/_d/signin?continue=https%3A%2F%2Fdeveloper.android.com%2Fguide%2Ffragments%2Fcommunicate&prompt=select_account)
...
_don't_ have fragments communicate directly with other fragments or
with their host activity.

The `Fragment` library provides two options for communication: a shared
[`ViewModel`](https://developer.android.com/topic/libraries/architecture/viewmodel) and the Fragment
...
[`Bundle`](https://developer.android.com/reference/android/os/Bundle), use the Fragment
Result API.
...
[`ViewModel`](https://developer.android.com/reference/androidx/lifecycle/ViewModel) is an ideal choice when
...
[Kotlin](https://developer.android.com/guide/fragments/communicate#kotlin)[Java](https://developer.android.com/guide/fragments/communicate#java)More
...
[`MutableLiveData`](https://developer.android.com/reference/androidx/lifecycle/MutableLiveData) class.
[`LiveData`](https://developer.android.com/reference/androidx/lifecycle/LiveData) is a lifecycle-aware
...
If you're using the [Navigation library](https://developer.android.com/guide/navigation), you can also
scope a `ViewModel` to the lifecycle of a destination's
[`NavBackStackEntry`](https://developer.android.com/reference/androidx/navigation/NavBackStackEntry). For
...
implements
[`FragmentResultOwner`](https://developer.android.com/reference/androidx/fragment/app/FragmentResultOwner).
...
[`setFragmentResultListener()`](https://developer.android.com/reference/androidx/fragment/app/FragmentManager#setfragmentresultlistener)
...
![fragment b sends data to fragment a using a FragmentManager](https://developer.android.com/static/images/guide/fragments/fragment-a-to-b.png)**Figure 1.** Fragment B sends data to fragment A using a
`FragmentManager`.
...
so by using the
[`setFragmentResult()`](https://developer.android.com/reference/androidx/fragment/app/FragmentManager#setfragmentresult)
API:
...
[`launchFragmentInContainer`](https://developer.android.com/reference/kotlin/androidx/fragment/app/testing/package-summary#launchFragmentInContainer(android.os.Bundle,kotlin.Int,androidx.lifecycle.Lifecycle.State,androidx.fragment.app.FragmentFactory))
or
[`launchFragment`](https://developer.android.com/reference/kotlin/androidx/fragment/app/testing/package-summary#top-level-functions),
...
![a child fragment can use FragmentManager to send a result             to its parent](https://developer.android.com/static/images/guide/fragments/pass-parent-child.png)**Figure 2** A child fragment can use
