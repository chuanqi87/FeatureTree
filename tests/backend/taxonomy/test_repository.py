...
from featuretree.reporting.views import matrix_rows
from featuretree.core.storage import Repository, read_yaml, write_json, write_yaml
...
class RepositoryTests(unittest.TestCase):
    ...
    def test_explicit_pending_branches_are_valid_but_unmarked_empty_rollups_are_not(self):
        parent = feature()
        ...
        self.assertEqual(validate_tree({"sample": parent, child["id"]: child}, docs, paths, self.config), [])
        child.pop("granularity")
