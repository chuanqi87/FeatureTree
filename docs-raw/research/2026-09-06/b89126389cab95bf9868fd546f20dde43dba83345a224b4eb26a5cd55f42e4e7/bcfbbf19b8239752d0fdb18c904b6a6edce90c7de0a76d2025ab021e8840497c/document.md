...
![](https://media:201787905945571662)  
...
* 基于指定的节点，查询所需的节点信息
  ...
  ![](https://media:201787905945726663)  
...
![](https://media:201787905945758664)  
* 基于CustomNode的自定义绘制容器组件，仅支持类型为[ARKUI_NODE_CUSTOM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodetype)且无其他子节点的[ArkUI_Node](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-node8h)。绘制容器组件的宽和高不能为0，避免被无障碍辅助应用忽略或错误处理子节点树。
