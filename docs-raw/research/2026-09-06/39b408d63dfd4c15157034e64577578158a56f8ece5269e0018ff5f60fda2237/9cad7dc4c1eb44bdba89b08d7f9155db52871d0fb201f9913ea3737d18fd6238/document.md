...
similar to the previous example, with the addition of a [`cryptoObject`](https://developer.android.com/reference/androidx/biometric/BiometricPrompt.CryptoObject).
...
[androidx.biometric.BiometricPrompt.NO\_SPACE](https://developer.android.com/reference/androidx/biometric/BiometricPrompt#ERROR_NO_SPACE()),
[androidx.biometric.BiometricPrompt.UNABLE\_TO\_PROCESS](https://developer.android.com/identity/sign-in/androidx.biometric.BiometricPrompt.NO_SPACE),
[androidx.biometric.BiometricPrompt.ERROR\_TIMEOUT](https://developer.android.com/reference/androidx/biometric/BiometricPrompt#ERROR_TIMEOUT()), and similar. The
