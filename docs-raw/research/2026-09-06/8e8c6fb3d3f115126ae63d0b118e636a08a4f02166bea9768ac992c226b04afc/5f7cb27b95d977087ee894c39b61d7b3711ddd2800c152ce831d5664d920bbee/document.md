...
[Drawables overview](https://developer.android.com/guide/topics/graphics/2d-graphics).
...
retrieve it using [View binding](https://developer.android.com/topic/libraries/view-binding)or[`findViewById()`](https://developer.android.com/reference/android/view/View#findViewById(int)).
