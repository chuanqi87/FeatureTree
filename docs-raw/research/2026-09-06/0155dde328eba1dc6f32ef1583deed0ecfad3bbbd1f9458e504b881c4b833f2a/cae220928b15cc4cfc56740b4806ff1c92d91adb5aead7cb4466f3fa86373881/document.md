...
![](https://media:201787905990646536)  
...
![](https://media:201787905990796537)
...
|pageId^12+^|string|是|routerPage页面的唯一标识。|
...
|index^12+^|number|是|NavDestination在路由栈中的索引。|
|param^12+^|Object|否|NavDestination组件的参数。|
|navDestinationId^12+^|string|是|NavDestination组件的唯一标识ID。|
