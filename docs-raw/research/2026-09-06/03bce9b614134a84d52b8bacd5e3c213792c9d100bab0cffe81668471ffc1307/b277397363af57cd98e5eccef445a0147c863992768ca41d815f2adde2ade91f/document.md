...
3. 在左侧导航栏中选择"增长 \> App Linking \> 聚合链接"，选择"网址允许清单"页签，点击"添加允许清单规则"。
   ...
   ![](https://media:201787905784688457)
4. 使用正则表达式设置允许清单规则，设置完成后点击右上角的"发布"。

![](https://media:201787905784726458)  
...
3. 在左侧导航栏中选择"增长 \> App Linking \> 聚合链接"，选择"聚合链接"页签，点击"创建聚合链接"。
   ...
   ![](https://media:201787905784794459)
4. 设置短链接，完成后点击"下一步"。

   ![](https://media:201787905784831460)  
...
5. 设置深度链接，完成后点击"下一步"。
   ...
   * 深度链接地址不允许设置为可执行文件格式。
   ...
   ![](https://media:201787905784882461)  
...
6. 设置聚合链接在HarmonyOS系统的链接行为，完成后点击"下一步"。
   ...
   ![](https://media:201787905784922462)  
...
7. （可选）在"设置跟踪参数"页面，设置广告跟踪参数，可用于广告、流量跟踪。
   ...
   ![](https://media:201787905784956463)  
...
8. （可选）设置社交分享标识，可用于社交软件之间的分享，设置完成后点击"下一步"。
   ...
   ![](https://media:201787905784989464)  
   ...
   ![](https://media:201787905785025465)  
...
9. （可选）设置预览页，可以将用户引导至合适的目标位置。
   ...
   ![](https://media:201787905785080466)  
...
* 点击网址中的二维码图标，或对应操作栏下方的"二维码下载"，可以下载该聚合链接的二维码图片。
  ...
  ![](https://media:201787905785119467)

  点击对应操作栏下方的"链接详情"，可以查看该聚合链接的详情，包括深度链接地址、HarmonyOS应用包名、短链接地址等。

![](https://media:201787905785157468)  
...
4. 选择"聚合链接"页签，对已创建的聚合链接进行归档。
   ...
   * 单条归档：在聚合链接列表，选择待归档聚合链接对应"操作"列下方的"归档"。
     ...
     ![](https://media:201787905785205469)
   * 批量归档：在列表，勾选多条待归档，选择右上角"批量操作"的下拉选项中的"归档"。

     ![](https://media:201787905785248470)

   ![](https://media:201787905785292471)  
...
![](https://media:201787905785322472)  
