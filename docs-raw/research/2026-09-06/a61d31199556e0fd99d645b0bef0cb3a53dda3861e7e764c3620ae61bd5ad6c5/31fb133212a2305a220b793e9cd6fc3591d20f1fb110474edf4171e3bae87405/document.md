...
# Use saved Preference values   Part of [Android Jetpack](https://developer.android.com/jetpack).
...
information, see [Use a custom datastore](https://developer.android.com/guide/topics/ui/settings/use-saved-values#custom-data-store).
