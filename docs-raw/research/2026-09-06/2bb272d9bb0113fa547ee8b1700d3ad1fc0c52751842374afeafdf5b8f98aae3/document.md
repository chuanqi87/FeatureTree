...
* [Get Android 17 on a Google Pixel device](https://developer.android.com/about/versions/17/get#on_pixel)
* [Get Android 17 Beta on a partner device](https://developer.android.com/about/versions/17/get#on_partner)
...
[Android Flash Tool](https://flash.android.com/release/17.0.0).
...
* [Phone](https://developer.android.com/about/versions/17/get#phone-avd)
* [Tablet or large-screen device](https://developer.android.com/about/versions/17/get#large-screen-avd)
...
5. From the **Phone Category tab**, select a device definition for a
   [supported Pixel device](https://developer.android.com/about/versions/17/get#on_pixel), then click the **Next** button.
