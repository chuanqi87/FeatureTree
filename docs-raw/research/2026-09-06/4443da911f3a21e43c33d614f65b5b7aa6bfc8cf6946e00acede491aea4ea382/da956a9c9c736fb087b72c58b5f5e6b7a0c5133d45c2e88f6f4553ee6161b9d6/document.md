...
![](https://media:201787905953418817)  
...
![](https://media:201787905953441818)  
...
* 非自由窗口状态下
  ...
  * 需要同时查看多个应用内容的场景。
  ...
  ![](https://media:201787905953468819)  
...
![](https://media:201787905953770820)
...
|接口|功能描述|触发时机|适用场景|
|:--------------------------------------------------------------------------------------------------------------------------------------------------|:----------|:-------------------------|:------------------------------------------------------------|
|[getWindowStatus()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#getwindowstatus12)|获取当前应用窗口的模式|应用主动调用|需要立即获取当前窗口模式进行判断的场景，如在执行某些窗口操作前，先判断当前窗口模式，避免在不支持的窗口模式下调用相关接口。|
...
![](https://media:201787905953798821)  
