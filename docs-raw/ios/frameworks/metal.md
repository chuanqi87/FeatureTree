...
[Skip Navigation](https://developer.apple.com/documentation/metal#app-main)
...
iOS 8.0+iPadOSMac Catalyst 13.0+macOS 10.11+tvOS 9.0+visionOS 1.0+

## [Overview](https://developer.apple.com/documentation/metal\#overview)
...
## [Topics](https://developer.apple.com/documentation/metal\#topics)

### [Essentials](https://developer.apple.com/documentation/metal\#Essentials)
...
### [Samples](https://developer.apple.com/documentation/metal\#Samples)
...
### [GPU devices](https://developer.apple.com/documentation/metal\#GPU-devices)
...
### [Command encoders](https://developer.apple.com/documentation/metal\#Command-encoders)
...
### [Resources](https://developer.apple.com/documentation/metal\#Resources)
...
### [Shader compilation and libraries](https://developer.apple.com/documentation/metal\#Shader-compilation-and-libraries)

Compile and organize shaders, the GPU functions that run on a Metal device’s execution units.

[Writing reusable GPU functions with generic pointers](https://developer.apple.com/documentation/metal/writing-reusable-gpu-functions-with-generic-pointers)
...
### [Presentation](https://developer.apple.com/documentation/metal\#Presentation)

Display standard or high-dynamic-range content on a device’s display with [Core Animation](https://developer.apple.com/documentation/quartzcore) or [MetalKit](https://developer.apple.com/documentation/metalkit), in standard or high dynamic range.
...
[Adapting your game interface for smaller screens](https://developer.apple.com/documentation/metal/adapting-your-game-interface-for-smaller-screens)

Make text legible on all devices the player chooses to run your game on.

[API Reference\\
Onscreen presentation](https://developer.apple.com/documentation/metal/onscreen-presentation)

Show the output from a GPU’s rendering pass to the user in your app.

[API Reference\\
HDR content](https://developer.apple.com/documentation/metal/hdr-content)

Take advantage of high dynamic range to present more vibrant colors in your apps and games.

### [Developer tools](https://developer.apple.com/documentation/metal\#Developer-tools)
...
[Logging shader debug messages](https://developer.apple.com/documentation/metal/logging-shader-debug-messages)
...
[API Reference\\
Metal debugging types](https://developer.apple.com/documentation/metal/metal-debugging-types)

Create capture managers and capture scopes, and review a GPU device’s log after it runs a command buffer.

### [Apple silicon](https://developer.apple.com/documentation/metal\#Apple-silicon)
...
### [Reference](https://developer.apple.com/documentation/metal\#Reference)
...
### [Classes](https://developer.apple.com/documentation/metal\#Classes)

[`class MTLTensorAuxiliaryPlaneDescriptor`](https://developer.apple.com/documentation/metal/mtltensorauxiliaryplanedescriptor)

A configuration for an auxiliary plane in a multi-plane tensor.

Beta

[`class MTLTensorAuxiliaryPlaneDescriptorMap`](https://developer.apple.com/documentation/metal/mtltensorauxiliaryplanedescriptormap)

A map of auxiliary plane descriptors keyed by plane type.

Beta

[`class MTLTensorAuxiliaryPlaneType`](https://developer.apple.com/documentation/metal/mtltensorauxiliaryplanetype)

An auxiliary plane that a shader’s tensor argument requires.

Beta

[`class MTLTensorBufferAttachments`](https://developer.apple.com/documentation/metal/mtltensorbufferattachments)

An object that associates each plane of a tensor with a buffer and byte offset for buffer-backed tensor creation.

Beta

### [Protocols](https://developer.apple.com/documentation/metal\#Protocols)

[`protocol MTLTensorAuxiliaryPlane`](https://developer.apple.com/documentation/metal/mtltensorauxiliaryplane)

A type that represents the configuration and storage of an auxiliary plane in a multi-plane tensor.

Beta

### [Structures](https://developer.apple.com/documentation/metal\#Structures)

[`struct MTLDeviceError`](https://developer.apple.com/documentation/metal/mtldeviceerror-swift.struct)

### [Variables](https://developer.apple.com/documentation/metal\#Variables)

[`let MTLDeviceErrorDomain: String`](https://developer.apple.com/documentation/metal/mtldeviceerrordomain)

### [Enumerations](https://developer.apple.com/documentation/metal\#Enumerations)

[`enum MTLFloatingPointConversionRoundingMode`](https://developer.apple.com/documentation/metal/mtlfloatingpointconversionroundingmode)

[`enum MTLTensorPlaneType`](https://developer.apple.com/documentation/metal/mtltensorplanetype)

The possible tensor plane types.

Beta

## [See Also](https://developer.apple.com/documentation/metal\#see-also)

### [Related Documentation](https://developer.apple.com/documentation/metal\#Related-Documentation)
