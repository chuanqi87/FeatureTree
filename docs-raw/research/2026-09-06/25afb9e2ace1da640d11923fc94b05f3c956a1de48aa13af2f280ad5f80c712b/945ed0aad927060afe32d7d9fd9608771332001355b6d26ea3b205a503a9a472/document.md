...
![](https://media:201787905914572205)  
* 随着应用模型的演进发展，从API 7开始支持的FA模型已经不再主推。当前FA模型主要用于Lite Wearable设备，相关指导详见[应用模型开发概述](https://developer.huawei.com/consumer/cn/doc/lite-wearable-guides/fa-model-development-overview)。
...
![](https://media:201787905914606206)
...
![](https://media:201787905914636207)
...
* 进程模型：在本例中，UIAbility组件默认运行在主进程中，FormExtensionAbility组件运行在独立进程中，UIAbility和FormExtensionAbility组件之间是进程隔离的。更多详情可参考[进程模型概述](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/process-model-overview)。
