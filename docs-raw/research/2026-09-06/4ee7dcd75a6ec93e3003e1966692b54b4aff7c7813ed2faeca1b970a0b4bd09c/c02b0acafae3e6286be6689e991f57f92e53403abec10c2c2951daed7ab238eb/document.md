...
provider](https://developer.android.com/training/sync-adapters/creating-stub-provider). In addition, you need your own content provider in the following cases:
...
[Data and file storage overview](https://developer.android.com/guide/topics/data/data-storage) and
[Design data storage](https://developer.android.com/guide/topics/providers/content-provider-creating#DataStorage).
...
[security tips for data storage](https://developer.android.com/privacy-and-security/security-tips#StoringData) and
[Content provider permissions](https://developer.android.com/guide/topics/providers/content-provider-basics#Permissions).
...
[Loaders](https://developer.android.com/training/load-data-background/setup-loader).
