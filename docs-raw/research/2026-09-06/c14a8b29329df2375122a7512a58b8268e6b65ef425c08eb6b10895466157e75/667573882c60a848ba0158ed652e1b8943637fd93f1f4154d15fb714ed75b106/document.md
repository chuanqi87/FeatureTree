...
**Note:** Please upgrade to version [1.1.0-alpha03](https://developer.android.com/jetpack/androidx/releases/media#1.1.0-alpha03) if you'd like to use
these new features. Version [1.1.0-alpha03](https://developer.android.com/jetpack/androidx/releases/media#1.1.0-alpha03) contains a critical
