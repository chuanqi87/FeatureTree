...
1. Open the profiler:
   ...
   ![Android Studio - Start Profiling](/static/develop/ui/compose/images/performance/tracing-1.png)


   **Figure 2**. Android Studio - Start Profiling
2. Click **CPU timeline**

   ![Android Studio Profiler - CPU timeline](/static/develop/ui/compose/images/performance/tracing-2.png)
...
3. Navigate your app to the UI you want to trace and then select **System
   ...
   ![Trace options - System trace](/static/develop/ui/compose/images/performance/tracing-3.png)
...
4. Use your app to cause recomposition and stop recording. Once the trace has
   ...
   ![An example of a system trace visualization in Android Studio.](/static/develop/ui/compose/images/performance/tracing-4.png)
...
5. You can also see composables in the Flame Chart along with the file and line
   ...
   ![An example of a flame chart displaying composable functions.](/static/develop/ui/compose/images/performance/tracing-5.png)
...
**Warning:** Don't ship `androidx.tracing:tracing-perfetto-binary` with your
production app as it has a large effect on your app size.
