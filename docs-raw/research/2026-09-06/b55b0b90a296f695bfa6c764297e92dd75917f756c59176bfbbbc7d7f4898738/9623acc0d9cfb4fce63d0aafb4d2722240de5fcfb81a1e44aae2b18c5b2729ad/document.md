...
![](https://media:201787906844423307)  
...
![](https://media:201787906844446308)  
bind方法调用成功后，才可调用此方法。
...
![](https://media:201787906844475309)  
bind方法调用成功后，才可调用此方法。
...
![](https://media:201787906844499310)  
...
![](https://media:201787906844533311)  
bind方法调用成功后，才可调用此方法。
...
![](https://media:201787906844562312)  
bind方法调用成功后，才可调用此方法。
...
![](https://media:201787906844588313)  
bind方法调用成功后，才可调用此方法。
...
|名称|类型|只读|可选|说明|
|:-----------|:-----|:-|:-|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|address^11+^|string|否|否|IP地址。|
|port|number|否|否|端口号 ，范围0\~65535。如果不指定系统随机分配端口。|
|family|number|否|否|网络协议类型，可选类型： - 1：IPv4。默认为1。 - 2：IPv6。地址为IPv6类型，该字段必须被显式指定为2。 - 3：Domain^18+^。地址为Domain类型，该字段必须被显式指定为3。当前仅支持[TCPSocket.connect](#connect)和[TLSSocket.connect](#connect9)。|
...
|proxy^18+^|[ProxyOptions](#proxyoptions18)|否|是|使用的代理信息，默认不使用代理。|
...
![](https://media:201787906844618314)  
...
![](https://media:201787906844642315)  
...
加入多播组。使用Promise异步回调。  
![](https://media:201787906844668316)  
多播使用的IP地址属于特定的范围（例如224.0.0.0到239.255.255.255）。
...
![](https://media:201787906844693317)  
多播使用的IP地址属于特定的范围（例如224.0.0.0到239.255.255.255）。
...
退出多播组。使用Promise异步回调。  
![](https://media:201787906844718318)  
多播使用的IP地址属于特定的范围（例如224.0.0.0到239.255.255.255）。
...
![](https://media:201787906844746319)  
...
![](https://media:201787906844771320)  
用于限制数据包在网络中传输时能够经过的最大路由器跳数的字段，TTL (Time to live)。
...
![](https://media:201787906844798321)  
用于限制数据包在网络中传输时能够经过的最大路由器跳数的字段，TTL (Time to live)。
...
![](https://media:201787906844824322)  
用于限制数据包在网络中传输时能够经过的最大路由器跳数的字段，TTL (Time to live)。
...
![](https://media:201787906844854323)  
...
![](https://media:201787906844877324)  
用于设置环回模式，开启或关闭两种状态，默认为开启状态。
...
![](https://media:201787906844906325)  
用于获取当前环回模式开启或关闭的状态。
...
![](https://media:201787906844928326)  
用于获取当前环回模式开启或关闭的状态。
...
![](https://media:201787906844959327)  
* [bind](#bind)方法调用成功后，才可调用此方法。
* bind异常、Socket已关闭（如调用close后）等异常情况下调用本接口会返回-1。
* 文件描述符的生命周期由系统管理，应用可以通过[close](#close)方法关闭Socket连接，避免直接操作文件描述符进行关闭。
...
![](https://media:201787906844982328)  
...
![](https://media:201787906845009329)  
bind方法如果因为端口冲突而执行失败，则会由系统随机分配端口号。
...
![](https://media:201787906845042330)  
...
![](https://media:201787906845065331)  
在没有执行tcp.bind的情况下，也可以直接调用该接口完成与TCP服务端的连接。
...
![](https://media:201787906845090332)  
...
![](https://media:201787906845114333)  
connect方法调用成功后，才可调用此方法。该接口为耗时操作，请在Worker线程或taskpool线程调用该接口。
...
![](https://media:201787906845341334)  
...
![](https://media:201787906845364335)  
connect方法调用成功后，才可调用此方法。
...
![](https://media:201787906845391336)  
...
![](https://media:201787906845412337)  
bind或connect方法调用成功后，才可调用此方法。
...
![](https://media:201787906845438338)  
* bind或connect方法调用成功后，才可调用此方法。
...
![](https://media:201787906845462339)  
* bind或connect方法调用成功后，才可调用此方法。
* 文件描述符的生命周期由系统管理，应用可以通过[close](#close-2)方法关闭Socket连接，避免直接操作文件描述符进行关闭。
...
![](https://media:201787906845488340)  
bind或connect方法调用成功后，才可调用此方法。
...
![](https://media:201787906845512341)  
bind或connect方法调用成功后，才可调用此方法。
...
![](https://media:201787906845537342)  
bind方法调用成功后，才可调用此方法。
...
|tcpFastOpen^24+^|boolean|否|是|是否在TCPSocket连接中启用TCP快速打开（TCP Fast OPen， TFO），该功能允许客户端在首次握手时携带数据，从而减少连接建立的延迟，提升高频率短连接场景下的性能表现。默认为false。true：支持快速打开属性；false：不支持快速打开属性。 当前参数只支持客户端配置。 模型约束： 此接口仅可在Stage模型下使用。|
...
![](https://media:201787906845561343)  
...
![](https://media:201787906845589344)  
服务端使用该方法完成bind，listen，accept操作，bind方法失败会由系统随机分配端口号。
...
![](https://media:201787906845612345)  
...
![](https://media:201787906845638346)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906845667347)  
...
![](https://media:201787906845702348)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906845732349)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906845756350)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906845781351)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906845806352)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906845833353)  
...
![](https://media:201787906845862354)  
...
![](https://media:201787906845884355)  
与客户端建立连接后，才可调用此方法。
...
![](https://media:201787906845909356)  
与客户端建立连接后，才可调用此方法。
...
获取对端Socket地址。使用callback异步回调。  
![](https://media:201787906845933357)  
与客户端建立连接后，才可调用此方法。
...
获取对端Socket地址。使用Promise异步回调。  
![](https://media:201787906845957358)  
与客户端建立连接后，才可调用此方法。
...
![](https://media:201787906845983359)  
* 与客户端建立连接后，才可调用此方法。
...
![](https://media:201787906846010360)  
...
示例：  
![](https://media:201787906846051361)  
...
![](https://media:201787906846075362)  
...
示例：  
![](https://media:201787906846101363)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846137364)  
connect方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846163365)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846188366)  
bind或connect方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846213367)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846406368)  
* bind或connect方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846455369)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846487370)  
bind或connect方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846516371)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846546372)  
bind或connect方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846573373)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846598374)  
bind方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846626375)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846650376)  
...
示例：  
![](https://media:201787906846678377)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846706378)  
listen方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846738379)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846772380)  
listen方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846796381)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846821382)  
listen方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846844383)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906846871384)  
listen方法调用成功后，才可调用此方法。
...
示例：  
![](https://media:201787906846900385)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906847076386)  
...
示例：  
![](https://media:201787906847102387)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906847133388)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847156389)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847182390)  
...
示例：  
![](https://media:201787906847211391)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906847245392)  
...
![](https://media:201787906847281393)  
...
示例：  
![](https://media:201787906847314394)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906847347395)  
* 成功建立连接后，才可调用此方法。
* 连接断开、Socket已关闭（如调用close后）等异常情况下调用本接口会返回-1。
...
示例：  
![](https://media:201787906847380396)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
示例：  
![](https://media:201787906847409397)  
在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](https://media:201787906847441398)  
...
![](https://media:201787906847479399)  
...
![](https://media:201787906847508400)  
如果TLSSocket对象是通过TCPSocket对象升级创建的，可以不用执行bind方法。
...
![](https://media:201787906847540401)  
bind方法调用成功后，才可调用此方法。
...
|:-------|:----------------------------------------------------|:-|:-------------------------------------------------|
|type|string|是|订阅的事件类型。'message'：接收消息事件。|
|callback|Callback\<[SocketMessageInfo](#socketmessageinfo11)\>|是|回调函数。TLSSocket连接订阅某类接收消息事件触发的调用函数，返回TLSSocket连接信息。|
...
|:-------|:----------------------------------------------------|:-|:---------------------------------------------------|
|type|string|是|订阅的事件类型。'message'：接收消息事件。|
|callback|Callback\<[SocketMessageInfo](#socketmessageinfo11)\>|否|回调函数。TLSSocket连接取消订阅某类接收消息事件触发的调用函数，返回TLSSocket连接信息。|
...
![](https://media:201787906847568402)  
bind方法调用成功后，才可调用此方法。
...
![](https://media:201787906847603403)  
bind方法调用成功后，才可调用此方法。
...
![](https://media:201787906847645404)  
...
![](https://media:201787906847673405)  
* bind方法调用成功后，才可调用此方法。
...
|名称|类型|只读|可选|说明|
|:---------------------------------|:-------------------------------------------------------|:-|:-|:------------------------------------------------------|
|ca|string \| Array\<string\>|否|是|服务端的ca证书，用于认证校验服务端的数字证书。默认为系统预置CA证书^12+^。最多支持设置1000本证书。|
...
![](https://media:201787906847705406)  
...
![](https://media:201787906847738407)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847765408)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847789409)  
...
![](https://media:201787906847818410)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847844411)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847883412)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847909413)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847936414)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847967415)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906847999416)  
在TLSSocketServer通信连接成功之后，才可调用此方法。
...
![](https://media:201787906848027417)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906848068418)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906848096419)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906848137420)  
listen方法调用成功后，才可调用此方法。
...
![](https://media:201787906848171421)  
...
![](https://media:201787906848197422)  
...
![](https://media:201787906848226423)  
在TLSSocketServer通信连接成功之后，才可调用此方法。
...
![](https://media:201787906848264424)  
* 在TLSSocketServer通信连接成功之后，才可调用此方法。
* 连接断开、Socket已关闭（如调用close后）等异常情况下调用本接口会返回-1。
