...
![](https://media:201787906347051431)  
...
端云同步状态，为枚举类型。  
![](https://media:201787906347088432)  
...
|:-------------|:------|:-|:----------------------------------------------------------|
|uri|string|是|待下载文件uri。|
|needClean^12+^|boolean|否|是否删除已下载的文件。默认值为false表示不删除；true表示删除。 从API version 12开始支持该参数。|
...
#### replaceFileWithHistoryVersion^20+^
