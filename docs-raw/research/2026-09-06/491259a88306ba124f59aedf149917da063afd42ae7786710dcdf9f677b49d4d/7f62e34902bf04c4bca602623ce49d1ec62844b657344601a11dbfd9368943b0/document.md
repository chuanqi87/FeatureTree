...
![](https://media:201787906351150459)  
...
![](https://media:201787906351185460)  
从API version 9开始支持，从API version 10开始废弃，建议使用[obtainAllWorks^10+^](#workschedulerobtainallworks10)替代。
...
#### workScheduler.obtainAllWorks^10+^
...
从API version 9开始支持，从API version 10开始废弃，建议使用[isLastWorkTimeOut^10+^](#workschedulerislastworktimeout10)替代。
...
#### workScheduler.isLastWorkTimeOut^10+^
...
![](https://media:201787906351217461)  
...
|earliestStartTime^22+^|number|否|是|任务首次执行时间距离任务申请时间的间隔，单位：ms，默认为0，范围大于等于0。|
